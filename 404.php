    ...
    <div class="header__main">
      <div class="header__logo">
        <a href="index.php">
          ...
          <img  src="assetsimages/uploads/logo.png" alt="Realand">
        </a>
      </div><!-- .header__logo -->
...
<section class="error">
    <div class="container">
      ...
      <div class="error-404__main">
        <div class="row">
          <div class="col-md-6">
            <img  src="assetsimages/uploads/404.jpg" alt="404">
          </div><!-- error-404__img -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 newsletter__content">
        <img  src="assetsimages/icon_mail.png" alt="Newsletter" class="newsletter__icon">
	...
	<div class="footer__main">
		<div class="container">
			<div class="footer__logo">
				<h1 class="screen-reader-text">ReaLand</h1>
				<img  src="assetsimages/uploads/logo_dark.png" alt="ReaLand">
			</div><!-- .footer__logo -->
