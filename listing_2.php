        ...
        <main class="col-md-9">
          <div class="listing-sort listing-sort--main-listing">
            <div class="listing-sort__inner">
              ...
              <span class="listing-sort__result">1-6 of <?php echo populate_main_listing_total_num();?> results</span>
          ...
          <section class="main-listing__item-grid">
            ...
            populate_main_listing($page,$limit); 
            ?>
             ...
             <?php 
              ...
              ?>
                <li class="pagination__item">
                  ...
                  <a href="<?php $npage=$page-1; echo $_SERVER['SCRIPT_NAME']."?page=$npage"?>" class="pagination__link pagination__link_prev"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                
                </li>
            <?php } ?>

            <?php 
              for ($i=1; $i <= $divisionValue ; $i++) {  
                if($page== $i){
            ?>  
                <li class="pagination__item"><a href="<?php echo $_SERVER['SCRIPT_NAME']."?page=$i" ?>" class="pagination__link pagination__link--selected"><?php echo $i?></a></li>
            <?php 
                }else{ ?>
                  <li class="pagination__item"><a href="<?php echo $_SERVER['SCRIPT_NAME']."?page=$i" ?>" class="pagination__link"><?php echo $i?></a></li>
           <?php }
              }
            ?>
            ...
            <?php 
              ...
              ?>
            <li class="pagination__item"><a href="<?php $npage=$page+1; echo $_SERVER['SCRIPT_NAME']."?page=$npage"?>" class="pagination__link pagination__link_next"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
            <?php } ?>
          </ul><!-- pagination -->
        </main><!-- .col -->
      </div><!-- row -->
