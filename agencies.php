...
<section class="agencies-grid">
  <div class="container">
    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border ht-breadcrumbs--b-margin">
      ...
      <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Agencies List</span></li>
    </ul><!-- ht-breadcrumb -->
    <div class="agency__wrapper">
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_1.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
            ...
            <p class="agency__properties">15 properties total</p>
          </div><!-- .agency -->
        </div><!-- .col -->
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_2.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_3.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_4.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_5.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_6.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_7.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="agency">
            <div class="agency__thumbnail">
              <img src="assets/images/uploads/agency_8.png" alt="Agency Logo">
            </div><!-- .agency__thumbnail -->
            <div class="agency__detail">
              <h4 class="agency__name">Citi ESTATE Co.,</h4>
              <ul class="agency__social">
