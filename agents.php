...
<section class="agents-with-info">
  <div class="container">
    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border ht-breadcrumbs--b-margin">
      <li class="ht-breadcrumbs__item"><a href="index.php" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__title">Home</span></a></li>
      <li class="ht-breadcrumbs__item"><a href="agents.php" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__title">Agent</span></a></li>
      <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Agent List Style</span></li>
    </ul><!-- ht-breadcrumb -->
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6">
        <div class="famous-agents__single">
          <div class="famous-agents__header">
            <img src="assets/images/uploads/michael-drucker.jpg" alt="Michael Drucker">
          ...
          <div class="famous-agents__content">
            <h4 class="famous-agents__name"><a href="agents_single.php">Michael Drucker</a></h4>
            <span class="famous-agents__position">President | Realand&reg;</span>
            <ul class="famous-agents__contact">
              <li class="famous-agents__phone"><i class="fa fa-phone fa-fw" aria-hidden="true"></i><a href="tel:+3104326507">(310) 432 6507</a></li>
              <li class="famous-agents__email"><i class="fa fa-envelope-o fa-fw" aria-hidden="true"></i><a href="mailto:michael-druc@domain.com">Michael-druc@domain.com</a></li>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="famous-agents__single">
          <div class="famous-agents__header">
            <img src="assets/images/uploads/tristina_avelon.png" alt="Tristina Avelon">
            <ul class="famous-agents__social">
              <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i>
              </a></li>
              <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i>
          ...
          <div class="famous-agents__content">
            <h4 class="famous-agents__name"><a href="agents_single.php">Tristina Avelon</a></h4>
            <span class="famous-agents__position">President | Realand&reg;</span>
            <ul class="famous-agents__contact">
              <li class="famous-agents__phone"><i class="fa fa-phone fa-fw" aria-hidden="true"></i><a href="tel:+3104326507">(310) 432 6507</a></li>
              <li class="famous-agents__email"><i class="fa fa-envelope-o fa-fw" aria-hidden="true"></i><a href="mailto:michael-druc@domain.com">Michael-druc@domain.com</a></li>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="famous-agents__single">
          <div class="famous-agents__header">
            <img src="assets/images/uploads/donal_lucian.jpg" alt="Donal Lucian">
            <ul class="famous-agents__social">
              <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i>
              </a></li>
              <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i>
          ...
          <div class="famous-agents__content">
            <h4 class="famous-agents__name"><a href="agents_single.php">Donal Lucian</a></h4>
            <span class="famous-agents__position">President | Realand&reg;</span>
            <ul class="famous-agents__contact">
              <li class="famous-agents__phone"><i class="fa fa-phone fa-fw" aria-hidden="true"></i><a href="tel:+3104326507">(310) 432 6507</a></li>
              <li class="famous-agents__email"><i class="fa fa-envelope-o fa-fw" aria-hidden="true"></i><a href="mailto:michael-druc@domain.com">Michael-druc@domain.com</a></li>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="famous-agents__single">
          <div class="famous-agents__header">
            <img src="assets/images/uploads/cherry_whiston.jpg" alt="Cherry Whiston">
            <ul class="famous-agents__social">
              <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i>
              </a></li>
              <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i>
          ...
          <div class="famous-agents__content">
            <h4 class="famous-agents__name"><a href="agents_single.php">Cherry Whiston</a></h4>
            <span class="famous-agents__position">President | Realand&reg;</span>
            <ul class="famous-agents__contact">
              <li class="famous-agents__phone"><i class="fa fa-phone fa-fw" aria-hidden="true"></i><a href="tel:+3104326507">(310) 432 6507</a></li>
              <li class="famous-agents__email"><i class="fa fa-envelope-o fa-fw" aria-hidden="true"></i><a href="mailto:michael-druc@domain.com">Michael-druc@domain.com</a></li>
...
</section><!-- agents-with-info -->
<section class="agent-with-button">
  <div class="container">
    <h2 class="section__title">Agent with Button</h2>
    <div class="row">
      <div class="col-md-4">
        <div class="agent-with-button__single">
          <div class="agent-with-button__wrapper">
            <img src="assets/images/uploads/michael-drucker.jpg" alt="Michael Drucker">
            <div class="agent-with-button__agent">
              <h4 class="agent-with-button__agent-name">Michael Drucker</h4>
              <span class="agent-with-button__agent-position">Zephyr Real Estate</span>
              <img src="assets/images/rating.png" alt="Five Stars Rating">
            </div><!-- .agent-with-button__agent -->
          </div><!-- .agent-with-button__wrapper -->
          <a href="#" class="agent-with-button__cta">Contact Michael</a>
        </div><!-- .agent-with-button__single -->
      </div><!-- .col -->
      ...
      <div class="col-md-4">
        <div class="agent-with-button__single">
          <div class="agent-with-button__wrapper">
            <img src="assets/images/uploads/tristina_avelon.png" alt="Tristina Avelon">
            <div class="agent-with-button__agent">
              <h4 class="agent-with-button__agent-name">Tristina Avelon</h4>
              <span class="agent-with-button__agent-position">Zephyr Real Estate</span>
              <img src="assets/images/rating.png" alt="Five Stars Rating">
            </div><!-- .agent-with-button__agent -->
          </div><!-- .agent-with-button__wrapper -->
          <a href="#" class="agent-with-button__cta">Contact Tristina</a>
        </div><!-- .agent-with-button__single -->
      </div><!-- .col -->
      ...
      <div class="col-md-4">
        <div class="agent-with-button__single">
          <div class="agent-with-button__wrapper">
            <img src="assets/images/uploads/donal_lucian.jpg" alt="Donal Lucian">
            <div class="agent-with-button__agent">
              <h4 class="agent-with-button__agent-name">Donal Lucian</h4>
              <span class="agent-with-button__agent-position">Zephyr Real Estate</span>
              <img src="assets/images/rating.png" alt="Five Stars Rating">
            </div><!-- .agent-with-button__agent -->
          </div><!-- .agent-with-button__wrapper -->
          <a href="#" class="agent-with-button__cta">Contact Donal</a>
        </div><!-- .agent-with-button__single -->
      </div><!-- .col -->
    </div><!-- .row -->
  </div><!-- .container -->
</section><!-- .agent-with-button -->
