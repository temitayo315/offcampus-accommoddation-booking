                    ...
                    <div class="header__main">
                        <div class="header__logo">
                            <a href="index.php">
                                ...
                                <img src="images/uploads/logo.png" alt="Properti Connect">
                            </a>
                        </div><!-- .header__logo -->
            ...
            <section class="packages">
                <div class="container">
                    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
                        ...
                        <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Package</span></li>
                    </ul><!-- .ht-breadcrumb -->

                    <div class="packages__container">
                        <h1 class="packages__headline"><strong>3</strong> plans. Try for <strong>Free.</strong> Cancel <strong>Anytime.</strong></h1>
                        <?php
                        $query = "SELECT * FROM `agents` WHERE `id`= '" . $_SESSION['id'] . "' LIMIT 1";
                        $query_run = mysqli_query($con, $query);
                        $row = mysqli_fetch_array($query_run);
                        ?>
                        <?php if ($row['package'] == "Basic" && $row['status'] == "Active") { ?>
                            <h1 class="packages__headline">You are currently on the <strong>Basic Plan</strong>. You can upgrade to the  <strong>Gold or Platinum </strong>plan, to enjoy more of our services.</h1>
                        <?php } else if ($row['package'] == "Gold" && $row['status'] == "Active") { ?>
                            <h1 class="packages__headline">You are currently on the <strong style="color:gold;">Gold Plan</strong>. You can upgrade to the <strong style="color:silver;">Platinum </strong><strong>Plan</strong>, to enjoy more of our services.</h1>
                        <?php } else if ($row['package'] == "Platinum" && $row['status'] == "Active") { ?>
                            <h1 class="packages__headline">You are currently on the <strong style="color:silver;">Platinum </strong><strong>Plan</strong></h1>.
                        <?php } else if ($row['package'] == "Gold" && $row['status'] == "Suspended") { ?>
                            <h1 class="packages__headline">You are currently on the <strong style="color:gold;">Gold Plan</strong>. Your subscription has expired, <strong>please renew, </strong>to continue to enjoy our services, or upgrade to the <strong style="color:silver;">Platinum </strong><strong>Plan</strong>.</h1>
                            <a href="coming_soon.php" style="margin-top:-50px; margin-bottom:30px; margin-left:450px;" class="package__cta package__cta--featured">Renew your package</a>
                        <?php } else if ($row['package'] == "Platinum" && $row['status'] == "Suspended") { ?>
                            <h1 class="packages__headline">You are currently on the <strong style="color:silver;">Platinum Plan</strong>. Your subscription has expired,<strong>please renew, </strong>to continue to enjoy our Services.</h1>
                            <a href="coming_soon.php" class="package__cta package__cta--featured">Renew your package</a>
                        <?php } ?>
                        ...
                        <div class="row">
                                ...
                                <div class="package">
                                    <div class="package__wrapper">
                                        <header class="package__header">
                                            <h2 class="package__name">Basic</h2>
                                            <h3 class="package__price">₦0.00</h3>
                                            <p class="package__description">- Basic Ads on our site</p>
                                        </header><!-- package__header -->
                                        ...
                                        <div class="package__body">
                                            <ul class="package__features">
                                                ...
                                                <li class="package__feature">
                                                    <strong>Property Duration</strong>
                                                    <span>30 days</span>
                                                </li>
                                            </ul><!-- package__features -->
                                        </div><!-- .package__body -->
                                        <?php if ($row['package'] == "Basic" && $row['status'] == "Active") { ?>

                                            <footer class="package__footer">
                                                <a href="#" class="package__cta">Active Now</a>
                                            </footer><!-- .package__footer -->   
                                        <?php } else { ?>
                                            <footer class="package__footer">
                                            </footer><!-- .package__footer --> 
                                        <?php } ?>
                                    </div><!-- .package__wrapper -->
                                </div><!-- .package -->
                            </div><!-- .col -->
                            ...
                            <div class="col-md-4">
                                <div class="package package--featured">
                                    <div class="package__wrapper">
                                        <header class="package__header">
                                            <h2 style="color:gold;" class="package__name">Gold</h2>
                                            <h3 class="package__price">₦1,500.00<sup> /Month</sup></h3>
                                            <p class="package__description">- Basic Ads on our site</p>
                                            <p class="package__description">- Ads on two of our social media platforms</p>
                                            <p class="package__description">- Create stunning video ads for you using your photos or videos, to use on our site</p>
                                        </header><!-- package__header -->
                                        ...
                                        <?php if ($row['package'] == "Gold" && $row['status'] == "Active") { ?>

                                            <footer class="package__footer">
                                                <a href="#" class="package__cta package__cta--featured">Active Now</a>
                                            </footer><!-- .package__footer -->  
                                        <?php } else { ?>
                                            <footer class="package__footer">
                                                <a href="coming_soon.php" class="package__cta package__cta--featured">Buy this package</a>
                                            </footer><!-- .package__footer -->
                                        <?php } ?>
                            ...
                            <div class="col-md-4">
                                <div class="package">
                                    <div class="package__wrapper">
                                        <header class="package__header">
                                            <h2 style="color:silver;" class="package__name">Platinum</h2>
                                            <h3 class="package__price">₦2,500.00<sup> /Month</sup></h3>
                                            <p class="package__description">- Basic Ads on our site</p>
                                            <p class="package__description">- Ads on all of our social media platforms</p>
                                            <p class="package__description">- Create stunning video ads for you using your photos or videos, to use on our site and all our social media platforms</p>
                                            <p class="package__description">- Google Ads Support for a more wider reach</p>
                                            <p class="package__description">- Get featured on our site</p>
                                        </header><!-- package__header -->
                                        ...
                                        <?php if ($row['package'] == "Platinum" && $row['status'] == "Active") { ?>
                                            <footer class="package__footer">
                                            <a href="#" class="package__cta">Active Now</a>
                                            </footer><!-- .package__footer --> 
                                        <?php } else { ?>
                                            <footer class="package__footer">
                                            <a href="coming_soon.php" class="package__cta">Buy this package</a>
                                            </footer><!-- .package__footer -->
                                        <?php } ?>
                ...
                <div class="footer__main">
                    <div class="container">
                        <div class="footer__logo">
                            <h1 class="screen-reader-text">Properti Connect</h1>
                            <img src="images/uploads/logo_dark.png" alt="Properti Connect">
                        </div><!-- .footer__logo -->
