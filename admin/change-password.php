...
{
$sql=mysqli_query($con,"SELECT password FROM  admin where password='".$_POST['password']."' && username='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admin set password='".$_POST['newpassword']."', updationDate='$currentTime' where username='".$_SESSION['login']."'");
