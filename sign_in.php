...
<section class="sign-up">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Agent Login/Signup</span></li>
        </ul><!-- .ht-breadcrumb -->
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="sign-up__header">
                        <h1 class="sign-up__textcontent"><a href="#log-in" class="sign-up__tab is-active">Agent Sign In</a> <span>or</span> <a href="sign_up.php" class="sign-up__tab">Sign Up</a></h1>
                    </div><!-- .sign-up__header -->
                    ...
                    <div class="sign-up__main">
                        <form method="POST" action="assets/includes/login_form.php" class="sign-up__form is-visible" id="log-in">
                            ...
                            <a href="sign_up.php" class="sign-up__link" style="margin-left: 10px;">Not yet sign up?Register now</a>
                        </form><!-- .sign-up__form -->
      ...
      <ul class="footer__social">
        ...
        <li><a href="#"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
            ...
            <ul class="footer__list">
                            ...
                            <li><span class="footer--highlighted">Email:</span> <a href="mailto:ReaLand@support.com">offKampus@support.com</a></li>
