...
<html lang="en" class="no-js">
    <head>
        <!-- Basic need -->
        <businessName>OffKampus Accommodation</businessName>
        <meta charset="UTF-8">
                ...
                <div class="header__main">
                    ...
                    <div class="header__menu header__menu--v1">
                        <ul class="header__nav">
                            ...
                            <li class="header__nav-item">
                                <a href="student/" class="header__nav-link">Find a Roommate</a>
                            </li>
        ...
        <section class="property">
            <div class="container">
                <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
                    <li class="ht-breadcrumbs__item"><a href="#" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__businessName">Home</span></a></li>
                    <li class="ht-breadcrumbs__item"><a href="#" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__businessName">Property</span></a></li>
                </ul><!-- ht-breadcrumb -->
            </div><!-- .container -->

            <!-- query function to populate details start -->

            <?php
            if ($prpid != 0 || !empty($prpid)) {

                $query = " SELECT * FROM `property_details` JOIN `room_types` ON room_types.r_id = property_details.roomtype_id JOIN `location` ON location.id = property_details.location_id WHERE `prop_id` = $prpid";
                $query_run = mysqli_query($con, $query);
                $row = mysqli_fetch_array($query_run);
                ?>    

                <!-- query function to populate details end -->
                            ...
                            <ul class="property__main">
                                <li class="property__businessName property__main-item">
                                    <div class="property__meta">
                                        ...
                                        <span class="property__type"><h5><?php echo $row['types']; ?></h5></span>
                                    </div><!-- .property__meta -->
                                    <h2 class="property__name"><?php echo $row['prop_name']; ?></h2>
                                    <span class="property__address"><i class="ion-ios-location-outline property__address-icon"></i><?php echo $row['prop_address']; ?></span>
                                </li>
                                <li class="property__price property__main-item">
                                    <h4 class="property__price-primary">#<?php echo $row['prop_price']; ?></h4>
                                </li>
                            </ul><!-- .property__main -->
                ...
                <div class="property__container">
                    <div class="container">
                        <div class="row">
                            <main class="col-md-9">
                                <div class="property__feature-container">
                                        ...
                                        <div class="property__slider-container">
                                            ...
                                            <div class="property__slider-main">
                                                <div class="property__slider-images">
                                                    <?php
                                                    $query2 = "SELECT * FROM `images_table` WHERE `prop_id` = $prpid ";
                                                    ...
                                                    while ($qrow = mysqli_fetch_array($query_run2)) {
                                                        ...
                                                        <div class="property__slider-image">
                                                            ...
                                                            echo explode(".", $qrow['images_path'])[1];
                                                            if ($qrow['images_path'] == "" || array_search(explode(".", $qrow['images_path'])[3], $ext)):
                                                                ...
                                                                ?>"  style=" height: 500px;" alt="Image 1">
                                                                 <?php else: ?>
                                                                <video  controls>
                                                                    <source src="<?php
                                                                    if ($qrow['images_path'] == "") {
                                            ...
                                            <ul class="property__slider-nav property__slider-nav--horizontal">
                                                ...
                                                <li class="property__slider-item">
                                                    <?php
                                                    $query3 = "SELECT * FROM `images_table` WHERE `prop_id` = $prpid ";
                                                    $query_run3 = mysqli_query($con, $query3);
                                                    while ($qrow2 = mysqli_fetch_array($query_run3)) {
                                                        $Imid = $qrow2['id'];
                                                        ?>
                                                        <?php
                                                        $ext2 = array("png", "jpg", "jpeg", "gif");
                                                        echo explode(".", $qrow2['images_path'])[1];
                                                        if ($qrow2['images_path'] == "" || array_search(explode(".", $qrow2['images_path'])[3], $ext2)):
                                                            ?>
                                                            <img src="<?php
                                                            if ($qrow2['images_path'] == "") {
                                                                echo "assets/images/noimage.jpg";
                                                            } else if ($qrow2['images_path'] == ".." . substr($qrow2['images_path'], 2)) {
                                                                echo "assets" . substr($qrow2['images_path'], 2);
                                                            } else {
                                                                echo $qrow2['images_path'];
                                                            }
                                                            ?>" alt="Image 1">
                                                             <?php else: ?>
                                                            <video  controls>
                                    ...
                                    <div class="property__feature">
                                        <h3 class="property__feature-businessName">Days & Time of Inspection/visitation</h3>
                                        <div class="property__feature-schedule">
                                            <ul class="property__feature-time-list">
                                                <?php
                                                $open_house_id = $row['vacancy'];

                                                if ($row['vacancy'] != 0) {


                                                    $qr = "SELECT * FROM `open_property_details` WHERE  `open_prop_id` = $open_house_id ";
                                                    $qu_run = mysqli_query($con, $qr);
                                                    $qr_row = mysqli_fetch_array($qu_run);
                                                    ?>
                                                    <li class="property__feature-time-item"><?php echo $qr_row['day'] . " between " . $qr_row['time']; ?></li>
                                                <?php } else { ?>
                                                    <li class="property__feature-time-item" style="color: red">No Vacancy.!This house is not Yet Available for visit.</li>
                                                <?php } ?>

                                                <br></br>
                                                    
                                            </ul>
                                            <a href="#go_see_home" class="property__feature-cta">Go See This Home</a>
                                    ...
                                    <div class="property__feature">
                                        ...
                                        <ul class="property__details-list">
                                            <li class="property__details-item"><span class="property__details-item--cat">Location:</span><?php echo $row['location_name']; ?></li>
                                            <li class="property__details-item"><span class="property__details-item--cat">Proximity to school:</span> <?php echo $row['proximity']; ?><li>
                                            <li class="property__details-item"><span class="property__details-item--cat">Available Services/Amenities:</span><br/>
                                            <?php 
                                    ...
                                    <!-- TODO: Implement Nearest Structure + distance to main road --> 

                                    <div class="property__feature" id="go_see_home">
                                        <h3 class="property__feature-businessName property__feature-businessName--b-spacing">Schedule A Visit</h3>
                                        <?php
                                        if ($open_house_id != 0) {
                                            ?>
                                            <form method="POST" action="assets/includes/schedule_open_house_form.php?propeID=<?php echo $row['prop_id']; ?>" class="property__form">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="fname" class="property__form-field" placeholder="First Name" required>
                                                    </div><!-- col -->
                                                      <div class="col-sm-6">
                                                        <input type="text" name="lname" class="property__form-field" placeholder="Last Name" required>
                                                    </div><!-- col -->
                                                    <div class="col-sm-6">
                                                        <input type="text" name="contact" class="property__form-field" placeholder="Your Phone Number" required>
                                                    </div><!-- col -->
                                                    <div class="col-sm-6">
                                                        <textarea rows="4" name="message" class="property__form-field" placeholder="Message" required>I am Interested in your property and would like to make a survey of the building</textarea>
                                                    </div><!-- col -->
                                                    <div class="col-sm-12">
                                                        <input name="submit_open_house_contact_form" type="submit" class="property__form-submit" value="Book Schedule">
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                            </form>
                                        <?php } else { ?>
                                            <strong style="color:orange;">This Property Is Not Yet Open For Visit, You May Contact Seller/Agent <a href=#contact_agent>Contact <i class="fa fa-arrow-down"></i></a> </strong>
                                        <?php } ?>
                                    </div><!-- .property__feature -->
                            ...
                            $query4 = "SELECT * FROM `property_details` JOIN agents ON property_details.agent_id = agents.id WHERE prop_id = $prpid";
                            $query_run4 = mysqli_query($con, $query4);
                            $query_row = mysqli_fetch_array($query_run4);
                            ?>
                            <aside class="col-md-3">
                                <div class="widget__container">
                                    <section class="widget" id="contact_agent">
                                        <form method = "POST" action="assets/includes/contact_prop_form.php?prpID=<?php echo $query_row['prop_id']; ?>" class="contact-form contact-form--white" id="contact_form">
                                            <div class="contact-form__header">
                                                <div class="contact-form__header-container">
                                                    ...
                                                    if ($query_row['profile_pic'] == "profile_pic_goes_here") {
                                                        ...
                                                        echo "assets" . substr($query_row['profile_pic'], 2);
                                                    } else {
                                                        echo $query_row['profile_pic'];
                                                    }
                                                    ?>" alt="<?php echo $query_row['fname'] . " pic"; ?>" height="70px" width="70px;">
                                                    <div class="contact-info">

                                                        <span class="contact-company"><?php echo $query_row['businessName']; ?></span>
                                                        <strong class="contact-name"><a href="agents_single.php?usrid=<?php echo $row['agent_id']; ?>"><?php echo $query_row['fname']." ".$query_row['lname']; ?></a></strong>
                                                    </div><!-- .contact-info -->
                                            ...
                                            <div class="contact-form__body">
                                                ...
                                                <textarea class="contact-form__field contact-form__comment" cols="30" rows="5" placeholder="Comment" name="comment" required>I am interested in House <?php echo $row['prop_name'] . " at " . $row['prop_address']; ?></textarea>
                                            
                                            </div><!-- .contact-form__body -->

                                            <div class="contact-form__footer">
                                                <input type="submit" class="contact-form__submit" name="submit_contact_form" value="Contact Agent">
                                            </div><!-- .contact-form__footer -->
                                        </form><!-- .contact-form -->
                                    </section><!-- .widget -->

                                    <section class="widget widget--white widget--padding-20">
                                        <h3 class="widget__businessName">Similar Homes</h3>
                                        <?php
                                        $similar = $row['types'];
                                        $similar_price = $row['prop_price'];
                                        populate_similar_homes_buyer($similar, $similar_price);
                                        ?>
                                    </section><!-- .widget -->

                                    <section class="widget widget--white widget--padding-20 widget__news">
                                        <h3 class="widget__businessName">Let's find you a roomate</h3>
                                        
                                        <a href="student/" type="submit" class="btn btn-success btn-sm" style="background-color: #ff6600; color: #fff; text-align: center;"><i class="fa fa-search"></i> Find a Roomate</a>
                ...
                <div class="row">
                    <div class="col-md-6 newsletter__content">
                        ...
                        <div class="newsletter__text-content">
                            <h2 class="newsletter__businessName">Newsletter</h2>
        ...
        <footer class="footer">
            <div class="footer__main">
                <div class="container">
                    ...
                    <p></p><br>
                    <h3 class="footer__businessName" style="margin-bottom:3px;">Contact Us</h3>
                    <ul class="footer__list">
                        <li><span class="footer--highlighted">Address:</span> <a href="#">Somewhere in Nigeria</a></li>
                        <li><span class="footer--highlighted">Email:</span> <a href="mailto:ReaLand@support.com">properticonnect@support.com</a></li>
                        <li><span class="footer--highlighted">Phone:</span> <a href="tel:+8802993999">(+234)-70x-xxx-xxxx</a></li>
                    </ul><!-- .footer__list -->
                </div><!-- .container -->
            </div><!-- .footer__main -->
