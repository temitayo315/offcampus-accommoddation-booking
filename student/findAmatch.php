...
$_SESSION['redirect'] = "../my_profile.php";
...
<head>
	<!-- Basic need -->
	<title>OffKampus Accommodation</title>
	<meta charset="UTF-8">
  ...
  <style type="text/css">
    ...
    p{ font-weight: bolder; margin-top: 50px }
  </style>
</head>
...
<body>
  <header class="header header--blue">
      ...
      <div class="header__main">
        ...
        <div class="header__menu header__menu--v1">
          <ul class="header__nav">
            ...
            <li class="header__nav-item">
              <a href="#" class="header__nav-link">Find a Roommate</a>
            </li>
            <?php $qr=mysqli_query($con,"select * from students where stu_id='".$_SESSION['stu_id']."'");
            $qrrow=mysqli_fetch_array($qr); 

        if($qrrow['phone'] == "070xxxxxxxx"){
          ?>
          <span class="alert-icon"><i class="fa fa-bolt"></i></span><strong style="color:yellow;">Hey <?php echo get_profile_name(); ?> Please Update Your Profile To get in Touch with roommate</strong>
        <?php }
    ...
    <?php }else{ ?>
            ...
            <ul>
              ...
              <li class="setting"><a href="my_property.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i> Search Roommate</a></li>
              ...
              <li class="setting"><a href="includes/logout.php" class="setting__link"><i class="ion-ios-undo-outline setting__icon"></i>Log Out</a></li>
          </ul>
          </li>
    <?php } ?>
          </ul><!-- .header__nav -->
 ...
 <section class="my-profile">
   ...
   <?php 
   if ( get_user_profile_pic() == "" || get_user_profile_pic() == "profile_pic_goes_here") {
     ?>
     <!-- dismiss alert area start -->
     <div class="alert alert-danger"  role="alert"><span class="alert-icon"><i class="fa fa-bolt"></i></span>
      <strong>Hey <?php echo get_profile_name(); ?> Please Complete Your Profile By Uploading Your Profile Picture And Entering Your Contact Details. Choose File Below to Update  </strong>
  ...
  <div class="container">
    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
      ...
      <li class="ht-breadcrumbs__item"><a href="#" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__title">Student</span></a></li>
    ...
    <div class="my-profile__container">
      <div class="row">
        <div class="col-md-4">
          <h2 class="bookmarked-listing__headline">Welcome, <strong><?php echo get_profile_name();?></strong></h2>
          <div class="settings-block">
            <span class="settings-block__title">Manage Account</span>
            <ul class="settings">
              <li class="setting setting--current"><a href="profile.php" class="setting__link"><i class="ion-ios-person-outline setting__icon"></i>My Profile</a></li>

              <li class="setting setting--current"><a href="my_profile.php" class="setting__link"><i class="ion-ios-person-outline setting__icon"></i>Update Profile</a></li>
              <li class="setting"><a href="change_password.php" class="setting__link"><i class="ion-ios-unlocked-outline setting__icon"></i>Change Password</a></li>
              <li class="setting"><a href="inlcudes/logout.php" class="setting__link"><i class="ion-ios-undo-outline setting__icon"></i>Log Out</a></li>
            </ul><!-- settings -->
          </div><!-- .settings-block -->

          <div class="settings-block">
            <span class="settings-block__title">Student</span>
            <ul class="settings">
              <li class="setting"><a href="roommate_search.php" class="setting__link"><i class="fa fa-search"></i> Search For Roommate</a></li>
              <li class="setting"><a href="#" class="setting__link"><i class="fa fa-search"></i> Find a match</a></li>
              <li class="setting "><a href="stu_notifications.php" class="setting__link"><i class="fa fa-comment"></i>Notifications <label class="label label-pills label-danger"> </label></a></li>
              <li class="setting"><a href="../index.php" class="setting__link"><i class="fa fa-home"></i> Available Accommodations</a></li>  
            </ul><!-- settings -->
          </div><!-- .settings-block -->
        </div><!-- .col -->

          <div class="col-md-5" style="position:relative;left: 80px; float: right;">
            <div class="form-group">
              <form action="roommate_result.php" method="post" role="form">
                    <h3 class="submit-property__headline"> Kindly choose as appropriate to get a perfect match</h3>
                        <div class="submit-property__features">
                            <div class="form-group">
                              <p>Which bad habit can you tolerate?</p>
                                <div class="submit-property__wrapper">
                                <input type="radio" value="1" name="tolerance" class="form_control">
                                <label for="">Smoking</label>
                                 <input type="radio" value="2" name="tolerance" class="form_control">
                                <label for="">Person that fuck women up and down</label>
                                <input type="radio" value="3" name="tolerance" class="form_control">
                                <label for="">Drinking</label>
                                <input type="radio" value="4" name="tolerance" class="form_control">
                                <label for="">Snoring while sleeping</label>
                                <input type="radio" value="5" name="tolerance" class="form_control">
                                <label for="">Anger</label>
                                <input type="radio" value="6" name="tolerance" class="form_control">
                                <label for="">None</label>
                                </div><br>
                            </div><!-- .submit-property__group -->
                            <div class="form-group">
                              <p>What time is your best study period?</p>
                                <div class="submit-property__wrapper">
                                <input type="radio" value="1" name="study" class="form_control">
                                <label for="">Early morning</label>
                                <input type="radio" value="2" name="study" class="form_control">
                                <label for="">Day time</label>
                                <input type="radio" value="3" name="study" class="form_control">
                                <label for="">At night</label>
                                <input type="radio" value="4" name="study" class="form_control">
                                <label for="">Midnight</label>
                                </div><br>
                            </div><!-- .submit-property__group -->
                            <div class="form-group">
                              <p>How do you feel about sharing personal belongings?</p>
                                <div class="submit-property__wrapper">
                                <input type="radio" value="1" name="belongings" class="form_control">
                                <label for="">I don't mind sharing</label>
                                <input type="radio" value="2" name="belongings" class="form_control">
                                <label for="">I can't share</label>
                                </div><br>
                            </div><!-- .submit-property__group -->
                            <div class="form-group">
                              <p>What is your level of neatness?</p>
                                <div class="submit-property__wrapper">
                                <input type="radio" value="1" name="neatness" class="form_control">
                                <label for="">Very neat</label>
                                <input type="radio" value="2" name="neatness" class="form_control">
                                <label for="">Averagely</label>
                                </div>
                            </div><!-- .submit-property__group -->
                            <div class="form-group">
                              <p>How do you best fall asleep?</p>
                                <div class="submit-property__wrapper">
                                <input type="radio" value="1" name="sleep" class="form_control">
                                <label for="">With light on</label>
                                <input type="radio" value="2" name="sleep" class="form_control">
                                <label for="">Without light</label>
                                </div>
                            </div><!-- .submit-property__group -->
                            <input type="submit" name="findMatch" value="Search Query" class="btn btn-info btn-sm">
...
<footer class="footer">
  <div class="footer__main">
    <div class="container">
      ...
      <p class="footer__desc">OffKampus Accommodation is a platform for student to connect with agent online and rent accommodation.</p>
      ...
      <ul class="footer__list">
        ...
        <li><span class="footer--highlighted">Email:</span> <a href="mailto:ReaLand@support.com">temitayo315@gmail.com</a></li>
    ...
    <div class="container">
      <div class="footer__copyright-inner">
        <p class="footer__copyright-desc">
          &copy; 2019 <span class="footer--highlighted-v2">OffKampus Accommodation</span> Real Estate Platform in Nigeria. All Right Reserved.
        </p>
        <ul class="footer__copyright-list">
          <li><span class="footer--highlighted-v2">Site Developed By</span><a href="#" target="blank"> Ayanda Temitayo</a></li>
        </ul>
