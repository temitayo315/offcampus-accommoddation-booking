      ...
      <div class="header__main">
        ...
        <div class="header__menu header__menu--v1">
          <ul class="header__nav">
            ...
            <li class="header__nav-item">
              <a href="listing_2.php" class="header__nav-link">Find a Roommate</a>
            </li>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              ...
              <li class="setting "><a href="stu_notifications.php" class="setting__link"><i class="fa fa-comment"></i>Notifications <span class="badge"></span></a></li>
              <li class="setting"><a href="../index.php" class="setting__link"><i class="fa fa-home"></i> Available Accommodations</a></li>  
            </ul><!-- settings -->
          </div><!-- .settings-block -->
        </div><!-- .col -->
        <?php 
        $pq=mysqli_query($con,"select * from students where stu_id='".$_SESSION['stu_id']."'");
        ...
        ?>
          <div class="col-md-4">
            ...
            <h4 class="title">Last Name </h4>
             ...
             <h4 class="title">Gender:</h4>
              ...
              <h4>Expectation: </h4>
              <span><?php echo $row['expectation'];?></span>
          ...
          <div class="col-md-5">
            ...
            <div class="img-circle" style="margin:20px;">

            <img src="<?php if($row['photo'] == 'profile_pic_goes_here'){echo '../images/icon_user.png';}else{echo 'uploads/'.$row['photo'];} ?>" height="200px" width="200px">
          </div>
          </div><!-- .col -->
      </div><!-- .row -->
