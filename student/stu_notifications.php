  ...
  <div class="container">
    ...
    <div class="my-profile__container">
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              ...
              <li class="setting "><a href="#" class="setting__link"><i class="fa fa-comment"></i>Notifications <span class="badge"></span></a></li>
        ...
        <div class="col-md-8">
          <h4 style="color: #880000; margin-bottom: 30px"> See who Sent you a roomate Request</h4>
