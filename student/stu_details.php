    ...
    <ul class="header__nav">
      <li class="header__nav-item">
        <a href="index.php" class="header__nav-link">Home</a>
            ...
            <li class="header__nav-item">
              <a href="roommate_search.php" class="header__nav-link">Find a Roommate</a>
                </li>
                ...
                <?php }else{ ?>
                        ...
                        <li class="setting"><a href="roommate_search.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i> Search Roommate</a></li>
 ...
 <section class="my-profile">
   ...
   if ( get_user_profile_pic() == "" || get_user_profile_pic() == "profile_pic_goes_here") {
     ...
     <div class="alert alert-danger"  role="alert"><span class="alert-icon"><i class="fa fa-bolt"></i></span>
      <strong>Hey <?php echo get_profile_name(); ?> Please Complete Your Profile By Uploading Your Profile Picture And Entering Your Contact Details. Choose File Below to Update  </a></strong>
  ...
  <div class="container">
    ...
    <div class="my-profile__container">
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              ...
              <li class="setting"><a href="findAmatch.php" class="setting__link"><i class="fa fa-search"></i>Find a match</a></li>
        ...
        <?php 
        $pq=mysqli_query($con,"select * from students where stu_id='$stu_details'");
        ...
        ?>
          <div class="col-md-4">
            ...
            <h6 class="my-profile__label">Full Name</h6>
            <?php echo $row['firstname']." ".$row['lastname']; ?><br><br>

            <h6 class="my-profile__label">Gender</h6>
            <?php echo $row['gender']; ?><br><br>

            <h6 class="my-profile__label">Religion</h6>
            <?php echo $row['religion']; ?><br><br>

            <h6 class="my-profile__label">Phone Number</h6>
            <?php echo $row['phone']; ?><br><br>

            <h6 class="my-profile__label">Email</h6>
            <?php echo $row['email']; ?><br><br>

            <h6 class="my-profile__label">Here's my Expectation</h6>
            <?php echo $row['expectation']; ?><br><br>
        </div>
        <div class="property__feature">
           <h4 class="property__feature-title">Send a Message</h4>
           <div class="contact-form__body">
            <form method="post" action="includes/stu_message.php?more=<?php echo $reciever; ?>">
            <input type="text" class="hidden" name="sender" value="<?php echo $sender; ?>">
            <input type="text" class="hidden" name="reciever" value="<?php echo $reciever; ?>">
            <input type="text" value="<?php echo $fn.' '.$ln; ?>" readonly>
            <input type="text" value="<?php echo $email; ?>" readonly>
            <textarea class="contact-form__field contact-form__comment" cols="40" rows="10" name="message" required>Hello <?php echo $row['lastname']; ?>, I saw your details that you were looking for a roomate on <?php echo $row['date']; ?>. I would like to get in touch with you, please feel free to contact me in any of my line. Thank You </textarea>
            <input type="submit" class="contact-form__submit" name="submit_request" value="Send Notification">
            </form>
          </div>
    ...
    <div class="col-md-5">
      <h4 class="my-profile__label">About Me</h4>
      <?php echo $row['descr'];?>

      <img src="<?php if($row['photo'] == 'profile_pic_goes_here'){echo '../images/icon_user.png';}else{echo 'uploads/'.$row['photo'];} ?>" height="150px" width="200px">
        </div><!-- .col -->
      </div><!-- .row -->
