            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="sign-up__header">
                        <h1 class="sign-up__textcontent"><a href="#log-in" class="sign-up__tab is-active">Agent Sign In</a> <span>or</span> <a href="#sign-up" class="sign-up__tab">Sign up</a></h1>
                    </div><!-- .sign-up__header -->

                    <div class="sign-up__main"><!-- .sign-up__form -->
                       <form method="POST" action="assets/includes/login_form.php" class="sign-up__form is-visible" id="log-in">
                            <label for="log-in-email" class="sign-up__label">Email</label>
                            <input type="email"  name="email" class="sign-up__field" id="log-in-email" placeholder="Your e-mail goes here">
                            <label for="log-in-password" class="sign-up__label">Password</label>
                            <input type="password" name="pass" class="sign-up__field" id="log-in-password" placeholder="******">
                            <button type="submit" name="submit-login-form" class="sign-up__submit">Sign In</button>
                            <a href="#" class="sign-up__link" style="margin-left: 10px;">Forgot Password?</a>
                        </form><!-- .sign-up__form -->

                        <form method="POST" action="assets/includes/sign_up_form.php" class="sign-up__form" id="sign-up">
                            <label for="sign-up-name" class="sign-up__label">First Name</label>
                            <input type="text" name="fname" required class="sign-up__field" id="sign-up-name" placeholder="Enter your First name">
                             <label for="sign-up-name" class="sign-up__label">Last Name</label>
                            <input type="text" name="lname" required class="sign-up__field" id="sign-up-name" placeholder="Enter your Last name">
                            <label for="sign-up-email" class="sign-up__label">Email</label>
                            <input type="email" name="email" required class="sign-up__field" id="sign-up-email" placeholder="Your email goes here">
                            <label for="sign-up-password" class="sign-up__label">Password</label>
                            <input type="password" name="pass2" required class="sign-up__field" id="sign-up-password" placeholder="******">
                            <div class="sign-up__wrapper">
                                <input type="checkbox" name="checked_terms" value="read_terms" required for="sign-up-term" class="sign-up__checkbox">
                                <label for="sign-up-term" class="sign-up__desc">I agree to all statements in <a href="#">Terms of Service</a></label>
                            </div>

                            <button type="submit" name="submit-signup-form" class="sign-up__submit">Sign Up</button>
                        </form><!-- .sign-up__form -->
                    </div>
                </div>
            </div><!-- .row -->
