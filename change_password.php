...
$_SESSION['redirect'] = "change_password.php";
        ...
        <div class="my-profile__container">
            <div class="row">
              ...
              <li class="setting"><a href="contacts_details.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Contacts</a></li>
                    ...
                    <div class="settings-block">
                        <ul class="settings">
                            <li class="setting setting--current"><a href="change_password.php" class="setting__link"><i class="ion-ios-unlocked-outline setting__icon"></i>Change Password</a></li>
                            <li class="setting"><a href="logout.php" class="setting__link"><i class="ion-ios-undo-outline setting__icon"></i>Log Out</a></li>
                        </ul><!-- settings -->
                    </div><!-- .settings-block -->
                </div><!-- .col -->
                <form method="POST" action="assets/includes/update_password.php">
                    <div class="col-md-9">
                        <label for="profile-current-password" class="my-profile__label">Current Password</label>
                        <input type="password" required name="curpass" class="my-profile__field" id="profile-current-password">

                        <label for="profile-new-password" class="my-profile__label">New Password</label>
                        <input type="password" required name="newpass" class="my-profile__field" id="profile-new-password">

                        <label for="profile-confirm-password" class="my-profile__label">Confirm New Password</label>
                        <input type="password" required name="repnewpass" class="my-profile__field" id="profile-confirm-password">

                        <button type="submit" name="update_pass_submit" class="my-profile__submit">Save Changes</button>
                    </div><!-- .col -->
                </form>
            </div><!-- .row -->
