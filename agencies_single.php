    ...
    <div class="header__main">
      <div class="header__logo">
        <a href="index.php">
          ...
          <img src="assets/images/uploads/logo.png" alt="Realand">
        </a>
      </div><!-- .header__logo -->
        ...
        <ul class="header__nav">
          <li class="header__nav-item">
            ...
            <ul>
              ...
              <li><a href="index_3.php">Home 3</a></li>
              <li><a href="index_4.php">Home 4</a></li>
              <li><a href="index_5.php">Home 5</a></li>
            </ul>
          </li>
          <li class="header__nav-item">
            <a href="#" class="header__nav-link header__nav-link--v2">Listing</a>
            <ul>
              <li><a href="listing_1.php">Listing List 1</a></li>
              <li><a href="listing_5.php">Listing List 2</a></li>
              <li><a href="listing_2.php">Listing Grid</a></li>
              <li><a href="listing_3.php">Listing Full Map</a></li>
              <li><a href="listing_4.php">Listing Half Map</a></li>
            </ul>
          </li>
          <li class="header__nav-item">
            <a href="#" class="header__nav-link header__nav-link--v2">Property</a>
            <ul>
              <li><a href="single_property_1.php">Single Property 1</a></li>
              <li><a href="single_property_2.php">Single Property 2</a></li>
              <li><a href="single_property_3.php">Single Property 3</a></li>
            </ul>
          </li>
          <li class="header__nav-item">
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li><a href="bookmarked_listing.php">Bookmarked Listing</a></li>
                    <li><a href="change_password.php">Change Password</a></li>
                  </ul>
                </li>
                <li><a href="about_us.php">About Us</a></li>
                <li><a href="contact.php">Contact</a></li>
                <li><a href="agents.php">Agent List</a></li>
                <li><a href="agents_single.php">Agent Single</a></li>
                <li><a href="coming_soon.php">Coming Soon</a></li>
                <li><a href="404.php">404 Page</a></li>
                <li><a href="package.php">Packages</a></li>
                <li><a href="sign_up.php">Login/Signup</a></li>
              </ul>
          </li>
          <li class="header__nav-item"><a href="blog.php" class="header__nav-link header__nav-link--v2">Blog</a></li>
        </ul><!-- .header__nav -->

        <ul class="topbar__user topbar__user--uppercase">
          <li><a href="sign_up.php" class="topbar__link topbar__link--white">Sign In</a></li>
          <li><a href="sign_up.php" class="topbar__link topbar__link--white">Join</a></li>
        </ul>

      </div><!-- .header__menu -->

      <a href="submit_property.php" class="header__cta header__cta--outline">&plus; Submit Property</a>
    </div><!-- .header__main -->
  </div><!-- .container -->
</header><!-- .header -->
<section class="single agencies-single">
    <div class="container">
      <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border ht-breadcrumbs--b-margin">
        ...
        <li class="ht-breadcrumbs__item"><a href="#" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__title">Agencies</span></a></li>
        <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Agencies Single</span></li>
      </ul><!-- ht-breadcrumb -->
  
      <div class="single__wrapper agencies-single__wrapper">
        <div class="row">
          <div class="col-md-9">
            <div class="single__inner agencies-single__inner">
              <div class="single__avatar agencies-single__avatar">
                <img src="assets/images/uploads/agency_4.png" alt="Michael Beckle">
              </div><!-- .agencies-single__avatar -->
  
              <div class="single__detail agencies-single__detail">
                <h3 class="agencies-single__name">Citi ESTATE CO,.</h4>
                <ul class="agency__social agencies-single__social">
                  <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                </ul><!-- .agencies-single__social -->

                <ul class="agency__contact agencies-single__contact">
                  <li class="agency__contact-phone"><a href="tel:+3104326507">(310) 432-6507</a></li>
                  <li class="agency__contact-website"><a href="#">www.citistate.com</a></li>
                  <li class="agency__contact-email"><a href="mailto:CitiState@domain.com">CitiState@domain.com</a></li>
                  <li class="agency__contact-address">122-140 N Morgan St, Chiago, IL 60607, USA</li>
                </ul><!-- .agency__contact -->
                <p class="agencies-single__desc">
                  For me, it's not so much about chasing a commission on a one-time deal as keeping a happy client for a lifetime. One of my most memorable transactions and proudest moments as a Realand was when I negotiated a deal with a seller to work with my buyers while I listed their current home. I help the buyer and his pregnant wife get their new home 2 weeks after that. This was also during the holidays when lenders and title companies normally take long to close transactions. My clients were happy to move into their new home just in time for their new baby!
                </p>
              </div><!-- .agencies-single__detail -->
            </div><!-- agencies-single__inner -->
          </div><!-- .col -->
  
          <div class="col-md-3">
            <form class="contact-form contact-form--bordered agencies-single__contact-from">
              <div class="contact-form__header">
                <h3 class="contact-form__title">Contact CitiEstate Co,.</h3>
              ...
              <div class="contact-form__footer">
                <input type="submit" class="contact-form__submit" name="submit" value="Contact Agency">
              </div><!-- .contact-form__footer -->
            </form><!-- .contact-form -->
          </div><!-- .col -->
        </div><!-- .row -->
      </div><!-- .agencies-single__wrapper -->
    </div><!-- .container -->
  </section><!-- .agencies-single -->
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/real_house_luxury_villa.jpg" alt="Real House Luxury Villa" class="listing__img">
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">Real House Luxury Villa</a></h3>
              ...
              <div class="listing__details">
                ...
                <a href="single_property_1.php" class="listing__btn">Details <span class="listing__btn-icon"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/dream_house_take_away.jpg" alt="Dream House Take Away" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">House Take Away</a></h3>
              <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
              <p class="listing__price">$85,500/ <span class="listing__price--small">Month</span></p>
              <div class="listing__details">
                <ul class="listing__stats">
                  <li><span class="listing__figure">5<sup>&plus;</sup></span> Beds</li>
                  <li><span class="listing__figure">3</span> Baths</li>
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/weston_hightpointe_place.jpg" alt="Weston Hightpointe Place" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">Weston Hightpointe Place</a></h3>
              <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/sunhouse_apartment_c21.jpg" alt="Sunhouse Apartment C21" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">Sunhouse Apartment C21</a></h3>
              <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
              <p class="listing__price">$2,285,500</p>
              <div class="listing__details">
                <ul class="listing__stats">
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/castalia_shibakoen.jpg" alt="Castalia Shibakoen" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->  
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">Castalia Shibakoen</a></h3>
              <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
              <p class="listing__price">$2,285,500</p>
              <div class="listing__details">
                <ul class="listing__stats">
      ...
      <div class="col-md-4 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.php">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="assets/images/uploads/residia_nishi_azabu.jpg" alt="Residia Nishi Azabu" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <h3 class="listing__title"><a href="single_property_1.php">Residia Nishi Azabu</a></h3>
              <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
              <p class="listing__price">$2,285,500</p>
              <div class="listing__details">
                <ul class="listing__stats">
	...
	<div class="footer__main">
		<div class="container">
			<div class="footer__logo">
				<h1 class="screen-reader-text">ReaLand</h1>
				<img src="assets/images/uploads/logo_dark.png" alt="ReaLand">
			</div><!-- .footer__logo -->
...
<div id="page-loader">
    <div class="page-loader__logo">
        <img src="assets/images/uploads/logo_dark.png" alt="ReaLand Logo">
