...
$_SESSION['redirect'] = "../../create_open_property.php";
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="settings-block">
                        ...
                        <ul class="settings">
                            <li class="setting"><a href="my_property.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>My Property</a></li>
                             <li class="setting setting--current"><a href="create_open_property.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>Open house for Vacancy</a></li>
              ...
              <li class="setting"><a href="contacts_details.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Contacts</a> &nbsp;<span class="label label-pill label-danger count"></span></li>
                    ...
                    <div class="settings-block">
                        <ul class="settings">
                            ...
                            <li class="setting"><a href="logout.php" class="setting__link"><i class="ion-ios-undo-outline setting__icon"></i>Log Out</a></li>
                                ...
                                <form action="assets/includes/create_open_prop_form.php" method="post" enctype="multipart/form-data">
                    <div class="col-md-9">
                        <div class="submit-property__block">
                            <h3 class="submit-property__headline">Organize Schedule For Property</h3>

                            
                                <div class="submit-property__group">
                                    <label for="property-name" class="submit-property__label">Select Your Property *</label>
                                    <select required id="property-name" class="ht-field" name="property">
                                        <?php
                                                $query = "SELECT * FROM `property_details` WHERE `agent_id` = '".$_SESSION['id']."' AND `vacancy` = '0' ORDER by `prop_id` DESC" ;
                            ...
                            <div class="submit-property__group">
                                <label for="property-days" class="submit-property__label">Days of the Week*</label>
                                <input type="text" class="submit-property__field" name="days" id="property-days" placeholder="e.g. Mondays - Thursdays, Mondays Only, Weekends Only" required>
                            </div><!-- .submit-property__group -->

                          <div class="col-sm-6">
                                <label for="property-time_from" class="submit-property__label">From</label>
                            <div class="property__form-wrapper">
                              <input id="property-time_to" type="text" name="time_from" class="property__form-field property__form-time" placeholder="07:30 AM" required>
                              <span class="ion-android-alarm-clock property__form-icon"></span>
                            </div><!-- .property__form-wrapper -->
                          </div><!-- col -->

                          <div class="col-sm-6">
                                <label for="property-time_to" class="submit-property__label">To</label>
                            <div class="property__form-wrapper">
                              <input id="property-time_from" type="text" name="time_to" class="property__form-field property__form-time" placeholder="07:30 PM" required>
                              <span class="ion-android-alarm-clock property__form-icon"></span>
                            </div><!-- .property__form-wrapper -->
                          </div><!-- col -->
                            
                    <button type="submit" name="submit_open_property_form" class="submit-property__submit">Open Schedule</button>
                </div><!-- .col -->
            </form>
