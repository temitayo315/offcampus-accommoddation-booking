...
$_SESSION['redirect'] = "../../submit_property.php";

if(loggedin()){
    if(check_user() == 0){
        ?><script>
            window.alert('Please Update Your Profile Details To Submit New Property');
        ...
        <div class="submit-property__container">
            <div class="row">
              ...
              <li class="setting"><a href="contacts_details.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Contacts</a></li>
                ...
                <form action="assets/includes/property.php" method="post" enctype="multipart/form-data" id="myform">
                    <div class="col-md-9">
                        <div class="submit-property__block">
                            <h3 class="submit-property__headline">Add New property</h3>

                            <div class="submit-property__group">
                                <label for="property-title" class="submit-property__label">Property Name *</label>
                                <input type="text" class="submit-property__field" name="title" id="property-title" placeholder="Name of house" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        <label for="property-room" class="submit-property__label">Proximity to school *</label>
                                        <select class="ht-field" id="property-rental-period" name="proximity" required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        ...
                                        <input type="number" class="submit-property__field" id="property-price" name="price" required>
                          ...
                          <!-- .submit-property__group -->
                            ...
                            <div class="submit-property__group">
                                ...
                                <select required name="state" id="state" class="ht-field">
                                    <option disabled value="All" selected>See Locations</option>
                        ...
                        <div class="submit-property__group">
                            ...
                            <input required type="text" class="submit-property__field" id="property-address" name="address">
                        </div><!-- .submit-property__group -->
                    </div><!-- .submit-property__block -->

                    <div class="submit-property__block">
                        <h3 class="submit-property__headline"> Available Services Or Amenities</h3>
                            ...
                            <div class="submit-property__group">
                               <div class="col-md-5">
                                    <div class="submit-property__group">
                                        ...
                                        <textarea cols="10" rows="10" class="submit-property__field" id="property-map-address" name="rules"></textarea>
                                    </div><!-- .submit-property__group -->
                               </div>
                            </div><!-- .submit-property__group -->
                        </div><!-- .submit-property__features -->
                    ...
                    <div class="submit-property__block">
                    <div class="row">
                    <button type="submit" name="submit_property" class="submit-property__submit">Upload Property</button>
                </div>
                </div>
                </div><!-- .col -->
            </form>
      ...
      <div class="container">
         <div class="footer__copyright-inner">
            ...
            <ul class="footer__copyright-list">
                <li><span class="footer--highlighted-v2">Site Developed By</span><a href="" target="blank"> Timtech Technologies</a></li>
            </ul>
