...
<body>
      ...
      <div class="header__main">
        ...
        <div class="header__menu header__menu--v1">
          <ul class="header__nav">
            ...
            <?php $qr=mysqli_query($con,"select * from agents where id='".$_SESSION['id']."'");
        $qrrow=mysqli_fetch_array($qr); 

        if($qrrow['phone'] == "070xxxxxxxx"){
          ?>
          <span class="alert-icon"><i class="fa fa-bolt"></i></span><strong style="color:yellow;">Hey <?php echo get_profile_name(); ?> Please Update Your Profile To Submit New Property</strong>
        <?php }else{ ?>
 ...
 <section class="my-profile">
   ...
   if ( get_user_profile_pic() == "" || get_user_profile_pic() == "profile_pic_goes_here") {
     ...
     <div class="alert alert-warning"  role="alert"><span class="alert-icon"><i class="fa fa-bolt"></i></span>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              <li class="setting setting--current"><a href="my_profile.php" class="setting__link"><i class="ion-ios-person-outline setting__icon"></i>My Profile</a></li>
            </ul><!-- settings -->
          </div><!-- .settings-block -->
          ...
          <div class="settings-block">
            ...
            <ul class="settings">
              ...
              <?php $qr2=mysqli_query($con,"select * from agents where id='".$_SESSION['id']."'");
              $qrrow2=mysqli_fetch_array($qr2); 

              if($qrrow2['phone'] == "070xxxxxxxx"){
                ?>
                <span class="alert-icon"><i class="fa fa-bolt"></i></span><strong style="color:green;">Hey <?php echo get_profile_name(); ?> Please Update Your Profile To Submit New Property</strong>
              <?php }else{ ?>
        ...
        <?php 
        $pq=mysqli_query($con,"select * from agents where id='".$_SESSION['id']."'");
        $row=mysqli_fetch_array($pq);
        ?>
        <form method="POST" action="assets/includes/update_profile_form.php" enctype="multipart/form-data">
          <div class="col-md-4">
            <label for="profile-first-name" class="my-profile__label">First Name</label>
            <input type="text" name="fname" value="<?php echo $row['fname'];?>" class="my-profile__field" id="profile-first-name">

            <label for="profile-first-name" class="my-profile__label">Last Name</label>
            <input type="text" name="lname" value="<?php echo $row['lname'];?>" class="my-profile__field" id="profile-first-name">

            <label for="profile-title" class="my-profile__label">Agent Title/ Real Estate Name</label>
            <input type="text" value="<?php echo $row['businessName'];?>" placeholder="Title Here" name="title" required class="my-profile__field" id="profile-title">

            <label for="profile-number" class="my-profile__label">Phone Number*</label>
            <input type="number" value="<?php echo $row['phone'];?>"  required onkeypress="if(this.value.length==11)return false;" name="phone" placeholder="Enter your 11 digit phone number" class="my-profile__field" id="profile-number">

            <label for="profile-address" class="my-profile__label">Agent/ Real Estate Company Address</label>
            <input type="text" value="<?php echo $row['address'];?>" placeholder="Address Here" name="address" required class="my-profile__field" id="profile-address">
            ...
            <input type="text" name="tweet" required value="<?php echo $row['twitter'];?>" class="my-profile__field" id="profile-twitter">

            <label for="profile-facebook" class="my-profile__label">Facebook Address</label>
            <input type="text" required name="facebook" value="<?php echo $row['facebook'];?>" class="my-profile__field" id="profile-facebook">

          </div><!-- .col -->

          <div class="col-md-5">
            <label for="profile-introduce" class="my-profile__label">About Me</label>
            <textarea id="profile-introduce" required name="about" rows="10" class="my-profile__field"><?php echo $row['about'];?></textarea>

            <img src="<?php if($row['profile_pic'] == "profile_pic_goes_here"){echo "assets/images/noimage.jpg";}else if($row['profile_pic'] == "..".substr($row['profile_pic'], 2) ){ echo "assets".substr($row['profile_pic'], 2); }else{echo $row['profile_pic'];} ?>" height="200px" width="200px;">
