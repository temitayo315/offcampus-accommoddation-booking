...
$_SESSION['redirect'] = "../../single_property_1.php";
            ...
            <section class="property">
                <div class="container">
                    <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
                        ...
                        <li class="ht-breadcrumbs__item"><a href="#" class="ht-breadcrumbs__link"><span class="ht-breadcrumbs__title">My Property</span></a></li>
                    </ul><!-- ht-breadcrumb -->
                </div><!-- .container -->
                            ...
                            <ul class="property__main">
                                <li class="property__title property__main-item">
                                    <div class="property__meta">
                                        ...
                                        <span class="property__type"><?php echo $row['types']; ?></span>
                                    </div><!-- .property__meta -->
                ...
                <div class="property__container">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="property__feature-container">
                                        ...
                                        <div class="property__feature-schedule">
                                            <ul class="property__feature-time-list">
                                                ...
                                                if ($row['vacancy'] != 0) {
                                                    ...
                                                    ?>
                                                    <li class="property__feature-time-item"><?php echo $qr_row['day'] . " : " . $qr_row['time']; ?></li>
                                                <?php } else { ?>
                                                    <li class="property__feature-time-item" style="color: red">No Vacancy.!This house is not Yet Available for visit.</li> <?php } ?>
                                                    <br></br>
                                    ...
                                    <div class="property__feature">
                                        ...
                                        <ul class="property__details-list">
                                            ...
                                            <li class="property__details-item"><span class="property__details-item--cat">Available Amenities:</span>
                                             <?php 
                                    ...
                                    <div class="property__feature">
                                        <h3 class="property__feature-title property__feature-title--b-spacing">Rules</h3>
                                        <p><?php echo $row['rules'] ?></p><!-- .property__features-list -->
                                    </div><!-- .property__feature -->
                                    ...
                                    <div class="property__feature" id="go_see_home">
                                        <h3 class="property__feature-title property__feature-title--b-spacing">Scheduled Visits</h3>
                                        <div class="row">                      

                                        <?php populate_contact_open_property($prpid); ?>
                            ...
                            <?php
                            $user = $row['agent_id'];
                            $query4 = "SELECT * FROM `property_details` JOIN agents ON property_details.agent_id = agents.id";
                                ...
                                <div class="widget__container">
                                    ...
                                    <section class="widget widget--white widget--padding-20 widget__news">
                                        ...
                                        <ul class="widget__news-list">
                                            <li class="widget__news-item"><a href="#">Outer Sunset Real Estate: <span>Lekki Neighborhood Guide</span></a></li>
                                            <li class="widget__news-item"><a href="#">Pacific Heights Real Estate: <span>Victoria Island Neighborhood</span></a></li>
                                            <li class="widget__news-item"><a href="#">Mission District San Francisco: <span>Garki Abuja</span></a></li>
                                            <li class="widget__news-item"><a href="#">Hayes Valley Real Estate: <span>Port Harcourt Navy Neighborhood</span></a></li>
                                        </ul>
                                    </section><!-- .widget -->
