...
$_SESSION['redirect'] = "../../edit_open_house.php";
$prpeId=$_GET['id'];
if(loggedin()){
  ?>
  <!DOCTYPE html>
        ...
        <div class="submit-property__container">
            <div class="row">
              ...
              <li class="setting"><a href="contacts_details.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Contacts</a></li>
                            <li class="setting"><a href="#" class="setting__link"><i class="ion-ios-upload-outline setting__icon"></i>Submit New Property</a></li>
                ...
                <form action="assets/includes/edit_open_prop_form.php?propertid=<?php echo $prpeId ?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-9">
                        <div class="submit-property__block">
                            <h3 class="submit-property__headline">Organize Schedule For Property</h3>

                                <?php
                                      $query2 = "SELECT * FROM `open_property_details` WHERE `prop_id` = $prpeId" ;
                                ...
                                <div class="submit-property__group">
                                    ...
                                    <select required id="property-name" class="ht-field" name="property">
                                        <?php
                                                $query = "SELECT * FROM `property_details` WHERE `prop_id` = $prpeId" ;
                            ...
                            <div class="submit-property__group">
                                ...
                                <input type="text" class="submit-property__field" name="days" id="property-days" placeholder="e.g. Mondays - Thursdays, Mondays Only, Weekends Only" value="<?php echo $row2['day'];?>" required>
                            </div><!-- .submit-property__group -->

                          <div class="col-sm-6">
                                <label for="property-time_from" class="submit-property__label">From</label>
                            <div class="property__form-wrapper">
                              <input id="property-time_from" type="text" name="time_from" class="property__form-field property__form-time" placeholder="07:30 AM" required>
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="property__form-wrapper">
                              <input id="property-time_to" type="text" name="time_to" class="property__form-field property__form-time" placeholder="07:30 AM" required>
                              <span class="ion-android-alarm-clock property__form-icon"></span>
                            </div><!-- .property__form-wrapper -->
                          </div><!-- col -->
                            
                    <button type="submit" name="submit_open_property_form" class="submit-property__submit">Submit</button>
                </div><!-- .col -->
            </form>
