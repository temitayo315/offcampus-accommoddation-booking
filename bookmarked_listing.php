...
$_SESSION['redirect'] = "../../bookmarked_listing.php";
...
<section class="submit-property">
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="settings-block">
                        ...
                        <ul class="settings">
                            <li class="setting"><a href="my_profile.php" class="setting__link"><i class="ion-ios-person-outline setting__icon"></i>My Profile</a></li>
                            <li class="setting setting--current"><a href="bookmarked_listing.php" class="setting__link"><i class="ion-ios-heart-outline setting__icon"></i>Bookmarked Listings</a></li>
                        </ul><!-- settings -->
                    </div><!-- .settings-block -->
                ...
                <div class="col-md-9">
                    <ul class="manage-list manage-list--bookmark">
                        <li class="manage-list__header">
                            <span class="manage-list__title"><i class="fa fa-bookmark-o" aria-hidden="true"></i> My bookmarked listings</span>
                            ...
                            <div class="manage-list__item-container">
                                <div class="manage-list__item-img">
                                    <a href="single_property_1.php">
                                        <img src="assets/images/uploads/manage-item-1.jpg" alt="Weston Hightpointe Place" class="listing__img">
                                    </a>
        ...
        </div><!-- .bookmarked-listing__container -->
    </div><!-- .container -->
</section><!-- .bookmarked-listing -->
