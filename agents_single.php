...
<html lang="en" class="no-js">
    ...
    <body>
                ...
                <div class="header__main">
                    <div class="header__logo">
                        <a href="index.php">
                            ...
                            <img src="assets/images/uploads/logo.png" alt="Properti Connect">
                        </a>
                    </div><!-- .header__logo -->
                    ...
                    <div class="header__menu header__menu--v1">
                        <ul class="header__nav">
                            ...
                            <li class="header__nav-item">
                                <a href="student/index.html" class="header__nav-link">Find Roommate</a>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="single__inner agents-single__inner">
                                ...
                                <?php populate_single_agent($agent_id); ?>
                        ...
                        ?>
                        <div class="col-md-3">
                            <form  method = "POST" action="assets/includes/contact_agent_single_form.php?usr_iD=<?php echo $row['id']; ?>" class="contact-form contact-form--bordered agents-single__contact-from">
                                <div class="contact-form__header">
                                    <h3 class="contact-form__title">Contact<p><p><?php echo $row['fname'].' '.$row['lname']; ?></p></h3>
        ...
        <section class="item-grid">
            <div class="container" >
                <div class="row">
                    <h2 style="margin-left:15px; margin-bottom:20px;">Agent's Listings:</h2>
                     <div style="max-height: 900px; overflow-y: scroll;">
                    <?php
                        populate_listings_for_single_agent($agent_id);
                    ?>
                    </div>
