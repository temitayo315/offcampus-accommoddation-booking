...
$_SESSION['redirect'] = "../../view_schedule_open_prop.php";
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="settings-block">
                        ...
                        <ul class="settings">
                            ...
                            <li class="setting setting--current"><a href="open_property.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Open Property</a></li>
                ...
                <div class="col-md-9">
                    <ul class="manage-list manage-list--my-property">
                        ...
                        <?php 
                         $query_run2=mysqli_query($con,"select * from property_details where prop_id = $ID");
                        $row2=mysqli_fetch_array($query_run2); 
                          ?>
                        <li class="manage-list__item">
                            <div class="manage-list__item-container">
                                <div class="manage-list__item-img">
                                    <a href="single_property_1.php?propID=<?php echo $row2['prop_id']; ?>">
                                        <img src="<?php if($row2['featured_img'] == ""){echo "assets/images/noimage.jpg";}else if($row2['featured_img'] == "..".substr($row2['featured_img'], 2) ){ echo "assets".substr($row2['featured_img'], 2); }else{echo $row2['featured_img'];} ?>" width="170px" height="200px" alt="<?php echo $row2['prop_name'].' image';?>" class="listing__img">
                                    </a>
                                </div><!-- manage-list__item-img -->
                        
                                <div class="manage-list__item-detail">
                                    <h3 class="listing__title"><a href="single_property_1.php"><?php echo $row2['prop_name']; ?></a></h3>
                                    <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span><?php echo $row2['prop_address']; ?></p>
                                    <p class="listing__price">#<?php echo $row2['prop_price']; ?></p>
                                </div>
                            </div><!-- .manage-list__item-container --><p></p><br></li><!-- .manage-list__item" -->
                             <h3 class="listing__title">Contact Scheduled List:</h3><br/>
                         <div style="max-height: 500px; overflow-y: scroll;">    
                          <?php populate_contact_open_property($ID); ?> 
                         </div>                        
                    </ul>
                </div><!-- .col -->
