...
$_SESSION['redirect'] = "../../my_property.php";
    ...
    <div class="container">
        ...
        <div class="submit-property__container">
            <div class="row">
              ...
              <li class="setting"><a href="contacts_details.php" class="setting__link"><i class="ion-ios-home-outline setting__icon"></i>View Contacts</a>
              &nbsp;<span class="label label-pill label-danger count"></span></li>
                ...
                <div class="col-md-9" >
                    ...
                    <ul class="manage-list manage-list--my-property">
                        <li class="manage-list__header">
                            ...
                            <span class="manage-list__title"><i class="fa fa-calendar-o" aria-hidden="true"></i> Date</span>
                        </li>
                        <div style="max-height: 500px; overflow-y: scroll;">
                          <?php populate_my_property(); ?> 
                        </div>     
                    </ul>
